...
Create Prompt lets you designs prompts for tasks relevant to your business use case including code generation. To get started, click on the **+ CREATE PROMPT** button as shown in the image below
...
In this section, you will ask the model to complete a sentence. Go back to the **Create Prompt** window and 
...
For the next task, you will use the model to perform sentiment analysis on a sentence, such as determining whether a movie review is positive or negative. Go back to the **Create Prompt** window and 
...
### Create Chat Prompt
Go back to the **Language** page and click on the **+ CREATE CHAT PROMPT** button to create a new chat prompt.
